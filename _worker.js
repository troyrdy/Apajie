...
// 建议修改为自己的 UUID
let userID = 'bc798409-a253-4a98-a581-be5c31146570';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.gov.se"

// 用于 CF 网站的代理 IP
const proxyIPs = ["139.162.60.187"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
